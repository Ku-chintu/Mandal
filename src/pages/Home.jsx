...
function Home() {
    ...
    <div className="w-full p-4 container m-auto">
      <section className=" xl:grid grid-cols-2 pb-44 mt-12">
        <div>
          ...
          <div className="mb-14">
            <p className="p-text">
              Streamline hiring and boost talent quality with an all-in-one
              platform.
            </p>
          </div>
          <div>
            <a href="/contactus" className="sm:mb-0 cursor-pointer">
              <button className="btn text-white rounded-full px-10 py-3.5 bg-primary">
                Get Started
              </button>
            </a>
          </div>
        ...
        <div className="flex md:justify-center align-middle items-center sm:px-18 lg:px-28 mt-10">
          <div className=" relative mr-12">
            ...
            <div className=" absolute top-1/4 sm:top-1/4 -right-10 sm:-right-28 md:-right-32">
              <div className=" h-12 w-44  sm:h-16  sm:w-52 p-4 bg-white shadow-2xl rounded-xl mb-2 sm:mb-4 text-sm sm:text-xl font-medium items-center flex justify-center text-center">
                Automation
              </div>
              <div className=" h-12 w-44  sm:h-16  sm:w-52 p-4 bg-white shadow-2xl rounded-xl mb-2 sm:mb-4 text-sm sm:text-xl font-medium items-center flex justify-center text-center">
                Efficiency
        ...
        <div className="hidden  xl:flex md:justify-center align-middle items-center px-4 md:px-12 lg:px-24 relative">
          <div className="">
            <img
              ...
              src={Landingpage}
              alt="image1"
              className=" bg-white pr-4 pb-4 "
            />
          </div>
          <img
            src={sec2top}
            alt="image1"
            className="w-96 h-auto absolute -top-64 left-0"
          />
        </div>
        <div className="relative">
          <div className=" mb-6 mt-0 xl:mb-14">
            <h1 className="heading-2 font-bold">
              Talent solution with seamless workflow integration
            </h1>
          </div>
          <div className="mb-10 relative">
            <p className="p-text">
              mAI streamlines your entire recruitment process into one platform,
              effortlessly integrating with your ATS for a unified workflow. By
              removing the reliance on multiple tools, mAI helps lower costs and
              boosts the overall efficiency of your talent acquisition process.
            </p>
            <img
              src={sec2Group}
              alt="image1"
              className="hidden xl:block w-96 h-auto absolute -bottom-72 right-0"
            />
          </div>
        </div>
      ...
      <section className=" xl:grid grid-cols-2">
        <div className="relative">
          ...
          <div className="mb-10 relative">
            <p className="p-text">
              mAI's integrated platform provides real-time insights throughout
              your recruitment process, empowering your team to make quicker,
              data-informed decisions. With in-depth reporting, you can monitor
              key metrics, adjust strategies proactively, and enhance
              recruitment results across your organization.
            </p>

            <img
              src={sec2top}
              alt="image1"
              className="w-96 h-auto absolute -top-96 left-0"
            />
          </div>
        </div>
      ...
      <section className=" xl:grid grid-cols-2 ">
        ...
        <div className="relative">
          ...
          <div className="mb-10 relative">
            <p className="p-text">
              mAI's platform is built to assist talent acquisition teams in
              filling requisitions more quickly and efficiently, whether for
              specialized roles or high-volume hiring. By automating key
              processes such as sourcing, screening, candidate engagement, and
              scheduling, mAI streamlines the recruitment process, ensuring
              quality candidates are placed swiftly and without unnecessary
              complexity.
            </p>
            <img
              src={sec2Group}
      ...
      <section className="pt-20 ">
        <div className="relative">
          ...
          <h1 className="heading-2 font-bold text-center text-5xl">
            What distinguishes mAI from the rest
          </h1>
          {/* </div> */}
          <img
            src={sec2top}
            alt="image1"
            className="w-96 h-auto absolute -top-20 left-0"
          />
        </div>
      </section>
      ...
      {accordionData.map((item, index) => (
        <div key={index} className="border-t border-primary py-3 overflow-hidden">
          ...
          >
            ...
            <button className="w-full text-xl flex px-4 py-2 font-semibold cursor-pointer">
              {item.title}
            </button>
          </div>
          <div
          ...
          >
            ...
            <div className="block xl:hidden pl-12 py-4">
              {openIndex === index && (
                <img
                  style={{ width: "100%" }}
                  src={
  ...
  <div className="hidden xl:flex justify-center align-middle items-center px-4 md:px-12 lg:px-24 relative">
    <div>
      {openIndex !== null && (
        <img
          style={{ width: "100%" }}
    ...
    <img
      src={sec2Group}
      alt="Decorative"
      className="hidden xl:block w-96 h-auto absolute -bottom-44 right-0"
    />
  </div>
</section>
